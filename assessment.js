...
/**
 * 名前の文字列を渡すと診断結果を返す関数
 * @param {string} userName ユーザの名前 「string=文字列」
 *@return {string} 診断結果
*/
function assessment(userName){
 ...
 //文のコード番号の合計を回答の数で割って添字の数値を求める
  const index = sumOfCherCode % answers.length; // 0 ~ answers.length - 1 の間の数値
